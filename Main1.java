...
public class Main1 {
    ...
    static String[] customerName = new String[200];
    static String[] mobile = new String[200];
    static String[] address = new String[200];
    static int[] stayDays = new int[200];
    static String[] roomType = {"AC Single","AC Double","Non-AC Single","Non-AC Double"};
    ...
    public static void bookRoom(Scanner sc) {
        ...
        if (!booked[room - 1]) {
            ...
            System.out.println("Customer Name : " + customerName[room - 1]);
    ...
    public static void generateBill(Scanner sc) {
        ...
        if (booked[room - 1]) {
            ...
            System.out.println("Address       : " + address[room - 1]);
            System.out.println("Room Number   : " + room);
            System.out.println("Room Type     : " + roomType[typeIndex]);
    ...
    public static void viewBookedRooms() {
        ...
        for (int i = 0; i < 200; i++) {
            if (booked[i]) {
                ...
                System.out.println("Room Type     : " + roomType[typeIndex]);
                System.out.println("Stay Days     : " + stayDays[i]);
                System.out.println("-----------------------------");
            }
        }
        if (!found) {
